...
//get additional strings if we're editing the page
if ($editing) 
{
...
//render the main page header, which reads the course name
...
while ($section <= $course->numsections) {
    ...
    if ($showsection) {
        ...
        echo '<li id="section-'.$section.'" class="section main clearfix'.$sectionstyle.'" >'; //'<div class="left side">&nbsp;</div>';
            ...
            echo '<div class="left side">'.$currenttext.($section-1).'</div>';
        // Note, 'right side' is BEFORE content.
